...
{ /*! Diagnostic display of all settings of a 2D plot.
  ...
  */
  ...
  std::cout << "legend_font_size " << plot.legend_text_font_size() << std::endl; // Font for both text and title.
  std::cout << "legend_font_weight " << plot.legend_font_weight() << std::endl; // normal or might be bold.
  std::cout << "legend_text_font_size " << plot.legend_text_font_size() << std::endl;
  ...
  std::cout << "legend_text_font_weight " << plot.legend_text_font_weight() << std::endl; // normal or might be bold?
